...
export default class BrowserApp {
  ...
  _showSetupGuide(container) {
    ...
    el.innerHTML = `
      ...
      <pre style="background:#1a1a2e;border:1px solid #2a2a42;border-radius:10px;padding:16px 20px;font-size:12px;text-align:left;line-height:1.8;color:#c0c0e0;margin-bottom:20px;">git submodule update --init vendor/browser.js
